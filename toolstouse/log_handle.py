...
class FileLogger(Logger):  # log文件输出类
    ...
    def __init__(self, logName):
        ...
        self.rHandler = RotatingFileHandler(
            "{}_{}.log".format(self.loggerName, datetime.datetime.now().strftime('%Y_%m_%d_%H_%M_%S')),
            maxBytes=1 * 1024, backupCount=3, encoding='utf-8')
